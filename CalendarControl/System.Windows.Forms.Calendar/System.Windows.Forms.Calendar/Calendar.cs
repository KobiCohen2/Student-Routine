...
namespace System.Windows.Forms.Calendar
{
        ...
        : ScrollableControl
    {
        ...
        {
            if (ItemTextEditing != null && AllowItemEdit)
            {
        ...
        {
            if (ItemTextEdited != null && AllowItemEdit)
            {
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Down && SelectedElementStart != null)
            {
                if (e.Shift)
            ...
            else if (e.KeyCode == Keys.Up && SelectedElementStart != null)
            {
                if (e.Shift)
                    sStart = SelectedElementStart;
